...
const Pesquisa = () => {
    ...
    return (
        <div className='pt-6'>
            ...
            <h1 className='text-center font-bold my-4 text-2xl'>Critica e sugestões</h1>
            ...
            {sucess && <div className='w-1/5 mx-auto'>
                ...
                }
                {
                    retorno.showCoupon && <div className='text-center border p-4 mb-4'>
                        ...
                        <br />
                        <span className='italic'>Tire um print ou foto desta tela e apresente no local da promoção.</span>
                    </div>
                }
            </div> }
        </div>
